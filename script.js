(function() {
    ...
    const translations = {
        fa: {
            ...
            about_p1: 'شرکت سامر با بهره‌گیری از شبکه‌ای گسترده از تأمین‌کنندگان معتبر در سطح جهانی، توانسته است نقشی کلیدی در تأمین مواد اولیه و محصولات راهبردی برای صنایع مختلف ایفا کند.',
            ...
            careers_subtitle: 'به تیم حرفه‌ای سامر بپیوندید',
            careers_intro: 'ما در سامر به دنبال افراد با استعداد، خلاق و متعهد هستیم. اگر به دنبال محیطی پویا و چالش‌های جذاب هستید، جای شما خالی است. لطفا رزومه خود را به career@samrel.ir ارسال کنید.',
            ...
            footer_text: 'تمامی حقوق برای شرکت سامر محفوظ است.',
            // جدید
